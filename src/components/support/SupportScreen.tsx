    ...
    <div className="space-y-4 text-left pb-6">
      ...
      <div className="bg-white dark:bg-[#101b33] rounded-2xl border border-slate-200/90 dark:border-slate-800/90 p-4 sm:p-5 shadow-xs space-y-3">
        <div>
          <h1 className="text-xs font-bold text-slate-900 dark:text-white leading-tight">
            Care & Support Directory
          </h1>
          <p className="text-[10px] text-slate-500">
            Verified hospitals, clinicians, ayurvedic practitioners, and financial advisors
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search doctors, hospitals, or clinics..."
            value={search}
      ...
      <div className="space-y-2.5 text-left">
        {filtered.map((item) => (
          <div
            key={item.id}
            className="bg-white dark:bg-[#101b33] rounded-2xl border border-slate-200/90 dark:border-slate-800/90 p-4 shadow-xs space-y-3 transition-colors"
          >
