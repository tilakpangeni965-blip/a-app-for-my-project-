...
export const MoreScreen: React.FC = () => {
  ...
  const handleSaveProfile = (e: React.FormEvent) => {
    ...
    // Sync with Emergency Contacts list box
  ...
  return (
    <div className="pb-6 text-left">
      {/* Profile Card */}
      <div className="mx-4 mt-2 mb-3 bg-white dark:bg-[#101b33] rounded-2xl border border-slate-100 dark:border-slate-800/90 p-4 shadow-xs">
        ...
        {/* Shortcut to Emergency List Box */}
        <div className="mt-2.5 pt-2 border-t border-slate-100 dark:border-slate-800/80">
          <button
            type="button"
            onClick={() => setActiveTab('health')}
            className="w-full py-1.5 px-2.5 rounded-xl bg-rose-50 dark:bg-rose-950/50 hover:bg-rose-100/70 dark:hover:bg-rose-900/50 border border-rose-200/80 dark:border-rose-900/50 text-rose-700 dark:text-rose-300 text-[11px] font-bold flex items-center justify-between transition-colors cursor-pointer"
          >
            <span className="flex items-center gap-1.5">
              <span className="w-2 h-2 rounded-full bg-rose-500 animate-pulse inline-block" />
              <span>Emergency List Box (Nepal Police 100, Ambulance 102)</span>
            </span>
      ...
      <div className="mx-4 mb-3 bg-white dark:bg-[#101b33] rounded-2xl border border-slate-100 dark:border-slate-800/90 p-4 shadow-xs space-y-3">
        ...
        <div className="flex items-center justify-between py-1 border-b border-slate-100 dark:border-slate-800/80">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-700 dark:text-slate-300">Theme Appearance</span>
          </div>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-slate-700 dark:text-slate-300">Verified Support Directory</span>
          </div>
          <span className="text-xs text-blue-600 dark:text-blue-400 font-semibold">View</span>
        </div>
      </div>

      {/* Privacy, Storage Separation & Security (Required by Section 6) */}
      <div className="mx-4 mb-3 bg-white dark:bg-[#101b33] rounded-2xl border border-slate-100 dark:border-slate-800/90 p-4 shadow-xs space-y-2.5">
        <div className="flex items-center gap-2">
          <Lock className="w-4 h-4 text-emerald-500" />
          <h4 className="text-xs font-bold text-slate-900 dark:text-white">
            Privacy & Data Separation Controls
          </h4>
        </div>

        <p className="text-[11px] text-slate-600 dark:text-slate-400 leading-relaxed">
          LifeShield maintains separate silos for your Health Concerns and Personal Financial records. No third-party data broker, external server, or advertising network receives your records.
        </p>
        ...
        <div className="pt-2 border-t border-slate-100 dark:border-slate-800/80 space-y-2">
          ...
          >
            ...
            <span>Export All Records (JSON Backup)</span>
          </button>
      ...
      {/* Mandatory Regulatory Disclaimers (Required by Section 6) */}
      <div className="mx-4 bg-slate-100/80 dark:bg-slate-900/60 rounded-2xl p-3.5 border border-slate-200/60 dark:border-slate-800/60 space-y-1.5 text-[10px] text-slate-500 leading-tight">
        <span className="font-semibold text-slate-700 dark:text-slate-300 block">
          Notice of Limitations & Terms
        </span>
        <p>
          1. <strong>Health Notice:</strong> Information organized in this application is for personal tracking and informational reference only. LifeShield does not provide medical diagnosis, clinical treatment plans, or emergency triage.
        </p>
        <p>
          2. <strong>Financial Notice:</strong> Policy summaries and finance trackers are user-managed estimates and do not constitute certified tax, investment, or legal underwriting advice.
        </p>
        <p>
          Version 1.0 (Phase 4 Prototype) • Build 2026.09
        </p>
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-xs">
          <div className="bg-white dark:bg-[#0f172a] max-w-sm w-full rounded-3xl p-5 border border-slate-200 dark:border-slate-800 shadow-2xl text-center space-y-3">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">
              This will erase all recorded health concerns, voice notes, financial transactions, claims, and reset all policies to defaults on this device. This cannot be undone.
            </p>
