...
import { FileCheck2, Plus, Clock, CheckCircle2, AlertCircle, Building2 } from 'lucide-react';
  ...
  return (
    <div className="pb-6">
      ...
      <div className="mx-4 mt-2 mb-3 bg-white dark:bg-[#101b33] rounded-2xl border border-slate-100 dark:border-slate-800/90 p-4 text-left shadow-xs">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-500">
                Cashless authorization & reimbursement claims
              </p>
            </div>
          </div>
        ...
        <div className="text-[11px] text-slate-500 dark:text-slate-400 pt-2 border-t border-slate-100 dark:border-slate-800/80">
          Average turnaround for cashless hospital pre-authorization: <strong className="text-slate-800 dark:text-slate-200">~45 minutes</strong>.
        </div>
      </div>
