...
export const EmergencyListBox: React.FC<EmergencyListBoxProps> = ({ compact = false }) => {
  ...
  return (
    <div className="mx-4 mb-3 bg-rose-50/90 dark:bg-rose-950/40 border border-rose-200/90 dark:border-rose-900/60 rounded-2xl p-3.5 shadow-xs text-left transition-colors">
      {/* Header with Title, Live Badge, and Add Contact Button */}
      <div className="flex items-center justify-between gap-2 mb-2.5">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 flex-wrap">
              ...
              <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-full bg-rose-200/80 dark:bg-rose-900/70 text-rose-800 dark:text-rose-300">
                List Box
              </span>
            </div>
            <p className="text-[10px] text-rose-800/80 dark:text-rose-300/80 leading-none mt-0.5 truncate">
              Nepal Police: 100 • Ambulance Support: 102 • User Contacts
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <button
            ...
            title="Add your own important contact"
          >
